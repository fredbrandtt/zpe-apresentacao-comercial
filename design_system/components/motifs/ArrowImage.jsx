...
export function ArrowImage({ src, size = 320, tone = 'blue', tint = true, style, ...rest }) {
  ...
  return (
    <svg viewBox="0 0 663 659" width={size} height={h} style={{ display: 'block', ...style }} {...rest}>
      <defs>
        <clipPath id={clipId}><path d={ARROW_PATH} /></clipPath>
      ...
      <g clipPath={`url(#${clipId})`}>
        {src ? (
          <>
            <image href={src} x="0" y="0" width="663" height="659" preserveAspectRatio="xMidYMid slice" />
            {/* grading azul da marca sobre a foto */}
            {tint && <rect width="663" height="659" fill="#16315f" opacity="0.34" />}
          </>
        ) : (
          <rect width="663" height="659" fill={`url(#${gradId})`} />
        )}
      </g>
    </svg>
  );
